...
const toolLogger = {
    info: (...args) => console.log('[WithdrawTippingFundsTool]', ...args),
    error: (...args) => console.error('[WithdrawTippingFundsTool ERROR]', ...args),
    warn: (...args) => console.warn('[WithdrawTippingFundsTool WARN]', ...args),
    debug: (...args) => console.debug('[WithdrawTippingFundsTool DEBUG]', ...args)
};
export default class WithdrawTippingFundsTool extends MCPTool {
    ...
    async execute(params, context) {
        try {
            ...
            let userCdpAccount;
            try {
                userCdpAccount = await cdpClient.evm.getAccount({ address: wallet.address });
