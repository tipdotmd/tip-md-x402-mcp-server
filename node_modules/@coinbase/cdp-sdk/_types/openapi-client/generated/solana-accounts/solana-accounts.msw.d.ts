...
import type { ExportSolanaAccount200, ExportSolanaAccountByName200, ListSolanaAccounts200, SignSolanaMessage200, SignSolanaTransaction200, SolanaAccount } from "../coinbaseDeveloperPlatformAPIs.schemas.js";
...
export declare const getExportSolanaAccountResponseMock: (overrideResponse?: Partial<ExportSolanaAccount200>) => ExportSolanaAccount200;
export declare const getExportSolanaAccountByNameResponseMock: (overrideResponse?: Partial<ExportSolanaAccountByName200>) => ExportSolanaAccountByName200;
...
export declare const getExportSolanaAccountMockHandler: (overrideResponse?: ExportSolanaAccount200 | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ExportSolanaAccount200> | ExportSolanaAccount200)) => import("msw").HttpHandler;
export declare const getExportSolanaAccountByNameMockHandler: (overrideResponse?: ExportSolanaAccountByName200 | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<ExportSolanaAccountByName200> | ExportSolanaAccountByName200)) => import("msw").HttpHandler;
