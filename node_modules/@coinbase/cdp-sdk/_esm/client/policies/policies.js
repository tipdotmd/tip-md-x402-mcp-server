...
export class PoliciesClient {
    ...
    async createPolicy(options) {
        ...
        return CdpOpenApiClient.createPolicy(options.policy, options.idempotencyKey);
    }
    /**
    ...
    async updatePolicy(options) {
        ...
        return CdpOpenApiClient.updatePolicy(options.id, options.policy, options.idempotencyKey);
    }
}
