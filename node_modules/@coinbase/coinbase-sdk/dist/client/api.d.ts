...
export declare const UserOperationStatusEnum: {
    readonly Pending: "pending";
    readonly Signed: "signed";
    readonly Broadcast: "broadcast";
    readonly Complete: "complete";
...
export declare const ExternalAddressesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    broadcastExternalTransaction: (networkId: string, addressId: string, broadcastExternalTransactionRequest: BroadcastExternalTransactionRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const ExternalAddressesApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    broadcastExternalTransaction(networkId: string, addressId: string, broadcastExternalTransactionRequest: BroadcastExternalTransactionRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BroadcastExternalTransaction200Response>>;
    /**
     * Broadcast an external address\'s transfer with a signed payload
     * @summary Broadcast an external address\' transfer
     * @param {string} networkId The ID of the network the address belongs to
...
export declare class ExternalAddressesApi extends BaseAPI implements ExternalAddressesApiInterface {
     ...
     */
    broadcastExternalTransaction(networkId: string, addressId: string, broadcastExternalTransactionRequest: BroadcastExternalTransactionRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<BroadcastExternalTransaction200Response, any>>;
    /**
     * Broadcast an external address\'s transfer with a signed payload
     * @summary Broadcast an external address\' transfer
     * @param {string} networkId The ID of the network the address belongs to
 ...
 * @export
 */
export declare const SmartWalletsApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    broadcastUserOperation: (smartWalletAddress: string, userOpHash: string, broadcastUserOperationRequest?: BroadcastUserOperationRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createSmartWallet: (createSmartWalletRequest?: CreateSmartWalletRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createUserOperation: (smartWalletAddress: string, networkId: string, createUserOperationRequest?: CreateUserOperationRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * Get smart wallet
     ...
     * @throws {RequiredError}
     */
    getSmartWallet: (smartWalletAddress: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * Get user operation
     ...
     * @throws {RequiredError}
     */
    getUserOperation: (smartWalletAddress: string, userOpHash: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * List smart wallets
     ...
     * @throws {RequiredError}
     */
    listSmartWallets: (limit?: number, page?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * SmartWalletsApi - functional programming interface
 * @export
 */
export declare const SmartWalletsApiFp: (configuration?: Configuration) => {
    /**
     * Broadcast a user operation
     * @summary Broadcast a user operation
     * @param {string} smartWalletAddress The address of the smart wallet to broadcast the user operation from.
     ...
     * @throws {RequiredError}
     */
    broadcastUserOperation(smartWalletAddress: string, userOpHash: string, broadcastUserOperationRequest?: BroadcastUserOperationRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserOperation>>;
    /**
     * Create a new smart wallet, not scoped to a given network.
     * @summary Create a new smart wallet
     * @param {CreateSmartWalletRequest} [createSmartWalletRequest]
     ...
     * @throws {RequiredError}
     */
    createSmartWallet(createSmartWalletRequest?: CreateSmartWalletRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SmartWallet>>;
    /**
     * Create a new user operation on a smart wallet.
     * @summary Create a new user operation
     * @param {string} smartWalletAddress The address of the smart wallet to create the user operation on.
     ...
     * @throws {RequiredError}
     */
    createUserOperation(smartWalletAddress: string, networkId: string, createUserOperationRequest?: CreateUserOperationRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserOperation>>;
    /**
     * Get smart wallet
     * @summary Get smart wallet by address
     * @param {string} smartWalletAddress The address of that smart wallet to fetch.
     ...
     * @throws {RequiredError}
     */
    getSmartWallet(smartWalletAddress: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SmartWallet>>;
    /**
     * Get user operation
     * @summary Get user operation
     * @param {string} smartWalletAddress The address of the smart wallet the user operation belongs to.
     ...
     * @throws {RequiredError}
     */
    getUserOperation(smartWalletAddress: string, userOpHash: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserOperation>>;
    /**
     * List smart wallets
     * @summary List smart wallets
     * @param {number} [limit] A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
     ...
     * @throws {RequiredError}
     */
    listSmartWallets(limit?: number, page?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SmartWalletList>>;
};
/**
 * SmartWalletsApi - factory interface
 * @export
 */
export declare const SmartWalletsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Broadcast a user operation
     * @summary Broadcast a user operation
     * @param {string} smartWalletAddress The address of the smart wallet to broadcast the user operation from.
 ...
 * @extends {BaseAPI}
 */
export declare class SmartWalletsApi extends BaseAPI implements SmartWalletsApiInterface {
    /**
     * Broadcast a user operation
     * @summary Broadcast a user operation
     * @param {string} smartWalletAddress The address of the smart wallet to broadcast the user operation from.
     ...
     */
    broadcastUserOperation(smartWalletAddress: string, userOpHash: string, broadcastUserOperationRequest?: BroadcastUserOperationRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<UserOperation, any>>;
    /**
     * Create a new smart wallet, not scoped to a given network.
     * @summary Create a new smart wallet
     * @param {CreateSmartWalletRequest} [createSmartWalletRequest]
     ...
     * @memberof SmartWalletsApi
     */
    createSmartWallet(createSmartWalletRequest?: CreateSmartWalletRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<SmartWallet, any>>;
    /**
     * Create a new user operation on a smart wallet.
     * @summary Create a new user operation
     * @param {string} smartWalletAddress The address of the smart wallet to create the user operation on.
     ...
     * @memberof SmartWalletsApi
     */
    createUserOperation(smartWalletAddress: string, networkId: string, createUserOperationRequest?: CreateUserOperationRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<UserOperation, any>>;
    /**
     * Get smart wallet
     * @summary Get smart wallet by address
     * @param {string} smartWalletAddress The address of that smart wallet to fetch.
     ...
     * @memberof SmartWalletsApi
     */
    getSmartWallet(smartWalletAddress: string, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<SmartWallet, any>>;
    /**
     * Get user operation
     * @summary Get user operation
     * @param {string} smartWalletAddress The address of the smart wallet the user operation belongs to.
     ...
     * @memberof SmartWalletsApi
     */
    getUserOperation(smartWalletAddress: string, userOpHash: string, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<UserOperation, any>>;
    /**
     * List smart wallets
     * @summary List smart wallets
     * @param {number} [limit] A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
     ...
     * @memberof SmartWalletsApi
     */
    listSmartWallets(limit?: number, page?: string, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<SmartWalletList, any>>;
}
/**
