...
import type { SendUserOperationOptions, SendUserOperationReturnType } from "../actions/sendUserOperation";
 ...
 */
export type NetworkScopedSmartWallet = Prettify<Omit<SmartWallet, "sendUserOperation"> & {
    /** The network configuration */
    network: Network;
    /** Optional URL for the paymaster service */
    paymasterUrl?: string;
    /** Sends a user operation to the configured network */
    sendUserOperation: <T extends readonly unknown[]>(options: Prettify<Omit<SendUserOperationOptions<T>, "chainId" | "paymasterUrl">>) => Promise<SendUserOperationReturnType>;
}>;
