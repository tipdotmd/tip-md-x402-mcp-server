...
export class SSEServerTransport extends AbstractTransport {
    type = "sse";
    _server;
    _connections; // Map<connectionId, { res: ServerResponse, intervalId: NodeJS.Timeout }>
    _sessionId; // Server instance ID
    _config;
    constructor(config = {}) {
        super();
    ...
    setupSSEConnection(res, connectionId) {
    ...
    cleanupConnection(connectionId, endResponse = false) {
        const connection = this._connections.get(connectionId);
        if (connection) {
